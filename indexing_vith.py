...
import json
import sys
from config import CLIP_EMBED_DIM_H
...
batches = ['vith-b1', 'vith-b2']

for batch in batches:
    
    BASE_PATH = os.path.join(REAL_DATA_DIR, 'Data', 'feature_metadata', batch, 'extracted_features')
    ...
    print(f"Indexing {feat_data.shape} embeddings from {batch}")
