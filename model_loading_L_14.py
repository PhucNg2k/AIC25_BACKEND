...
CONFIG = {
    ...
    'model_name': 'ViT-L-14',   # switched from H-14 to L-14
    'pretrained': 'laion2b_s32b_b82k',  # recommended pretrained weights for L-14
    'batch_size': 32,
    'num_workers': 4,
    'image_size': 224,
}
...
def load_index():
    ...
    # Adjusted filenames to reflect L-14
    index_save_path = "faiss_index_vitL_14.bin"
    metadata_save_path = "id_to_name_vitL_14.json"
